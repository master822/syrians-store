...
@section('title', 'تخفيضات ' . $categoryName)

@section('content')
<div class="container py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="text-center section-title gradient-text">🔥 تخفيضات {{ $categoryName }}</h1>
            <p class="text-center text-muted">اكتشف أفضل العروض والتخفيضات على {{ $categoryName }}</p>
        </div>
    </div>
    ...
    @else
        <div class="text-center py-5">
            ...
            <h4 class="text-muted">لا توجد تخفيضات في {{ $categoryName }} حالياً</h4>
            <p class="text-muted">يمكنك استعراض الأقسام الأخرى أو العودة لاحقاً</p>
            <a href="{{ url('/discounts') }}" class="btn btn-modern">استعراض جميع التخفيضات</a>
        </div>
    @endif
</div>
@endsection
