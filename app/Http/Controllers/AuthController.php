...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'store_name' => 'required_if:user_type,merchant|nullable|string|max:255',
            'store_category' => 'required_if:user_type,merchant|nullable|in:clothes,electronics,home,grocery',
            'store_description' => 'required_if:user_type,merchant|nullable|string|max:500',
            'store_phone' => 'required_if:user_type,merchant|nullable|string|max:20',
            'store_city' => 'required_if:user_type,merchant|nullable|string|max:255',
        ], [
